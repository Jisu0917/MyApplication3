...
public class PlayPracticeActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
                ...
                if (!screenLock) {
                    ...
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        ...
                        if (x < w*0.5 && ctrl == 'l') {
                            ...
                            if (light >= 15) {
                                light = 15;
                                Toast.makeText(PlayPracticeActivity.this, "밝기 최대", Toast.LENGTH_SHORT).show();
                            } else if (light <= 0) {
                                light = 0;
                                Toast.makeText(PlayPracticeActivity.this, "밝기 최소", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (vol >= 15) {
                                vol = 15;
                                Toast.makeText(PlayPracticeActivity.this, "볼륨 최대", Toast.LENGTH_SHORT).show();
                            } else if (vol <= 0) {
                                vol = 0;
                                Toast.makeText(PlayPracticeActivity.this, "음소거", Toast.LENGTH_SHORT).show();
                            }
...
//        }
    ...
    private void playVideo() {
        ...
        try {
            ...
            player.setDisplay(holder);
            mediaController = new MediaController(PlayPracticeActivity.this);
            player.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                @Override
                public void onPrepared(MediaPlayer mp) {
                    Log.d(TAG, "onPrepared called");
                    player.start();
                    mediaController.setMediaPlayer(PlayPracticeActivity.this);
