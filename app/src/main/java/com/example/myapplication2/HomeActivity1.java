    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(HomeActivity1.this, ShowPracticeActivity.class);
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity1.this, AddPracticeActivity.class);
...
//                break;
            ...
            case R.id.menu_edit:
                Intent intent = new Intent(HomeActivity1.this, EditPracticeActivity.class);
